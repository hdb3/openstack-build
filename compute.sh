...
COMPUTE-SERVICES="openvswitch libvirtd openstack-nova-compute neutron-openvswitch-agent"

systemctl enable COMPUTE-SERVICES
systemctl start COMPUTE-SERVICES
